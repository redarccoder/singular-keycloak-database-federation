...
public class DBUserStorageProviderFactory implements UserStorageProviderFactory<DBUserStorageProvider> {
    ...
    private synchronized ProviderConfig configure(ComponentModel model) {
        ...
        providerConfig.userConfiguration = new UserConfiguration(model.get("emailVerified"), model.get("enabled"));
    ...
    public List<ProviderConfigProperty> getConfigProperties() {
        return ProviderConfigurationBuilder.create()
                ...
                .helpText(
                        DEFAULT_HELP_TEXT + String.format(PARAMETER_HELP, "user username") + PARAMETER_PLACEHOLDER_HELP)
                .type(ProviderConfigProperty.STRING_TYPE)
                .defaultValue("select \"id\"," +
                        "            \"username\"," +
                        "            \"email\"," +
                ...
                .type(ProviderConfigProperty.LIST_TYPE)
                .options("Blowfish (bcrypt)", "MD2", "MD5", "SHA-1", "SHA-256", "SHA3-224", "SHA3-256", "SHA3-384",
                        "SHA3-512", "SHA-384", "SHA-512/224", "SHA-512/256", "SHA-512", "PBKDF2-SHA256", "Argon2d",
                        "Argon2i", "Argon2id")
                .defaultValue("SHA-1")
                .add()
                .build();
